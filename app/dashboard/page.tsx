  ...
  return (
    <section className="page-content route-shell route-dashboard" aria-labelledby="dashboard-title">
      <div className="page-header route-hero">
        <span className="route-badge">Personal control center</span>
        <h1 id="dashboard-title" className="page-title">Your dashboard</h1>
        <p className="page-description">
          Overview of your activity. Use the links below to jump to sessions, connections, or messages.
        </p>
      </div>
      {!hasProfile ? (
        <div className="rounded-card border border-amber-200 bg-amber-50 px-4 py-3 text-body-sm text-amber-800" role="status">
          Finish setting up: complete your profile in <Link href="/profile" className="underline focus-ring rounded">Profile</Link> so others can find you and you can book sessions.
        </div>
      ) : null}
      ...
      <div className="card-app card-app--muted route-dashboard-quick-actions">
        ...
        <p className="mt-1 text-caption text-slate-500">Go directly to what you need.</p>
