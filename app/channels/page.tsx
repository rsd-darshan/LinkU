...
export default async function ChannelsPage() {
  ...
  return (
    <section className="page-content route-shell route-channels" aria-labelledby="channels-title">
      <div className="page-header route-hero">
        <span className="route-badge">Community hubs</span>
        <h1 id="channels-title" className="page-title text-display">Channels</h1>
